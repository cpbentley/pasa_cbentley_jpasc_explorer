 ...
 *
 */
public class MenuBarPascalExplorerDaemonHelp extends MenuBarPascalAbstract implements ActionListener {
   ...
   public MenuBarPascalExplorerDaemonHelp(PascExplorerCtx pec, CBentleyFrame frame) {
